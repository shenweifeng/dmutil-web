...
<div id="common_up_div_01">
	...
	<form id="form1" method="post" enctype="multipart/form-data">
		...
		<input type="file" name="file" id="file" /><span></span><br />
		
	</form>
	
	<br /> <br />
	
	<input type="button" value="上传吧" onclick="upload()" /> <br /> <br />
...
<script>
	$(function() {
	    ...
	    upload = function() {  
	        ...
	        formData.append("file22", document.getElementById('file').files[0]);
	        //ajax异步上传  
	        $.ajax({  
	            ...
	            success: function(data){
	                $("#result").html(data.a+"<br/>"+data.d.d1+"<br/>"+data.d.d2);  
	            },  
